...
insert into journey_stages (id, key, title, tagline, description, time, status, actions, href) values
  ...
  (3, 'know-deal', 'Know Your Deal', 'Financing', 'Pre-qualify, compare interest rates and understand balloon payments.', '15 min', 'locked',
  ...
  (4, 'find-car', 'Find Your Car', 'Dealerships', 'Find trusted, CPA-compliant dealerships and compare their offers.', 'Ongoing', 'locked',
  ...
  (5, 'seal-deal', 'Seal The Deal', 'Documentation', 'Upload documents, analyse quotations and generate negotiation points.', '30 min', 'locked',
  ...
  (6, 'protect-ride', 'Protect Your Ride', 'Insurance & Aftercare', 'Compare insurance, manage your policy and track your warranty.', '20 min', 'locked',
